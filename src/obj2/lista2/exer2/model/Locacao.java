...
public class Locacao {
    ...
    public Locacao(Integer id, Date dataLocacao, Time horaLocacao, Date dataDevolucao, Time horaDevolucao, Integer quilometragem, Double valorCalcao, Double valor_locacao, Boolean devolvido) {
        this.id = id;
